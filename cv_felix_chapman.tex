...
\begin{itemize}
\item
Designed and developed the query language Graql (\href{https://github.com/aelred/grakn}{https://github.com/aelred/grakn})
\item
Utilised protocol buffers and gRPC to stream query results over HTTP
\item
Implemented processes such as code reviews and automated testing
\end{itemize}
...
\begin{itemize}
\item Experience using Windows, Linux and Mac OSX
